...
y_curr_tr, y_curr_te = train_test_split(dataset.iloc[1:,[1]], test_size=split, shuffle=False) # actual values
...
# test plot
plt.plot(y_curr_te.index[0:dsp], y_curr_te.values[0:dsp])
