...
if __name__ == '__main__':
    ...
    dcgan = DCGAN(args.load_discriminator, args.load_generator, args.output_directory, literal_eval("(128, 128)"))
    ...
    if args.sample == -1:
        ...
        dcgan.train(epochs=int(args.epochs), image_path="data/images/train_small/*.png", batch_size=int(args.batch_size), save_interval=int(args.save_interval))
    else:
